    ...
    return (
        <div className="bg-gradient-card border border-white/10 rounded-xl overflow-hidden mb-8 shadow-lg">
            ...
            <div className="p-6 space-y-6">
                <p className="text-text-secondary">No API key found. Create one to start collecting data.</p>
                <form onSubmit={handleCreateKey} className="space-y-4">
                    <div>
                        <label htmlFor="keyName" className="block text-sm font-medium text-text-muted mb-2">Key Name</label>
                        <input
                            id="keyName"
                            type="text"
                            value={keyName}
