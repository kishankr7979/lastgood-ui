...
## Corpus Check
- 65 files · ~29,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 313 nodes · 396 edges · 35 communities (29 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81297b0c`
...
### Community 3 - "App.jsx"
Cohesion: 0.15
Nodes (15): api, App(), toast, ToastContainer(), useHelpLoom(), queryClient, EventDetail(), fetchEvent() (+7 more)
